...
function Testimonials() {
    ...
    return (
        <div className='container text-center my-5'>
            <h3 className='mt-5 fw-bold text-success'>Client Review</h3>
            ...
            <div className ='row row-cols-3 g-4 mt-5'>
                {
                    reviews.map(review =>(
                        <article key={review.id}>
                          ...
                          <img src={review.img} className="card-img-top  w-50 d-block mx-auto"  alt="service-img"/>
                          <div className="card-body">
                          <h5 className="card-title my-3 text-primary">{review.name}</h5>
                          <h6 className="card-title my-3  text-success">{review.country}</h6>
