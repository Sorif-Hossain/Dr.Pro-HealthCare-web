...
const Header = () => {
  const{user, logOut} = useAuth();
    ...
    return (
      <div>
        <div className="logo">
          <h3 className="text-center text-danger">Dr.Pro <img width='60px' src={image} alt="" /> HealthCare</h3>
           </div>
      ...
      <nav className="navbar navbar-expand-md  navbar-light py-3">
          <h3 className="navbar-brand d-flex align-items-center">
            ...
            >
            Dr.Pro<span className="text-success">HealthCare</span>
            </NavLink>
          </h3>
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navmenu">
            ...
            <div className="collapse navbar-collapse" id="navmenu">
                ...
                {user?.email? <ul className="navbar-nav">
                                ...
                                <button className="nav-item btn btn-outline-dark ms-2" onClick={logOut}>Log Out</button>
                            </ul>
